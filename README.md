...
### How this fix is ultimately decided to be fixed

### What has already been done


### What is to be done now - as the next step to do
- Ignore comments in this section. I keep them just for my internal purposes.
...
- 📚**Curated, manageable context**: Selective inclusion of valuable insights only; stays compact (~few hundred lines)
- 💫 **Full flexibility**: Query anything (tiny or large), restart from any point, iterate endlessly
- 🏖️ **Seamless VS Code integration**: Easy file attachment and context building
